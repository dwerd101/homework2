 ...
 * (Вместо конструктора используй метод initialize)
 * - Имя
 * - Имя, возраст
 * - Имя, возраст, пол
 *
 ...
 * У класса должен быть метод initialize, принимающий в качестве параметра имя и
 *  инициализирующий соответствующую переменную класса.
 * У класса должен быть метод initialize, принимающий в качестве параметров имя, возраст и
 * инициализирующий соответствующие переменные класса.
 * У класса должен быть метод initialize, принимающий в качестве параметров имя, возраст, пол и
 *  инициализирующий соответствующие переменные класса.
 */
public class Friend {
    private String name;
